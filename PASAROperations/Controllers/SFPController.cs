    ...
    public class SFPController : Controller
    {
        ...
        public JsonResult countSummary(int furnace)
        {
            var cool = (from cp in cfdb.VWSFP_Pots_Data
                        where cp.Pot_Status == 1 && cp.SFP_ActualDTime == null && cp.SFP_Val_GroupId == furnace
        ...
        public void Add_SFP(string locationname, int potno, DateTime dtime, int cooltime, DateTime expdtime, string actualdtime, string dtemp, string remarks, int group, bool isForBreaking)
        {
            ...
            //cfdb.SFP_POTS_DATA_SP(locationid, dtime, potno, cooltime, expdtime, actdtime, dtemp, remarks, group);
            cfdb.SaveChanges();
        }

        public void Edit_SFP(int dataid, string locationname, int potno, DateTime dtime, int cooltime, DateTime expdtime, string actualdtime, string dtemp, string remarks, bool isForBreaking)
        {
