            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $.each(data, function (index, value) {
                        ...
                        if (value.MBF_DivisionId != currdiv) {
                            $('#mbfactual_' + value.MBF_ParamGroupId + ' tr:last').after('<tr id=' + currdiv + ' class="tr_data"><td colspan="4" style="text-align:center; background-color:#d1e7f6;"><b style="text-align:center;">' + value.MBF_DivisionName + '</b></td></tr>');
...
function load_mbf_actual_data(date_) {
    ...
    $.ajax({
        ...
        success: function (data) {
            $.each(data, function (index, value) {               
                $("#paramid_" + value.MBF_ParamId + "_" + value.MBF_ValTypeId + " input").val(value.MBF_NumVal == null ? "" : value.MBF_NumVal.toFixed(4));
            });
        }
    });
}
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $.each(data, function (index, value) {
                        ...
                        if (value.MBF_DivisionId != currdiv) {
                            $('#mbf_forecast_' + value.MBF_ParamGroupId + ' tr:last').after('<tr id=' + currdiv + ' class="tr_data"><td colspan="4" style="text-align:center; background-color:#d1e7f6;"><b style="text-align:center;">' + value.MBF_DivisionName + '</b></td></tr>');
