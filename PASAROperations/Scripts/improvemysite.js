...
function load_fsfe_fii_label() {
    ...
    $('#fsfe_label_time').text('-');
    $('#fsfe_label_shift').text('-');
    $('#fsfe_label_shiftmgr').text('-');
    $('#fsfe_label_spolead').text('-');
    $('#fsfe_label_fdopt').text('-');

    $('#fsfe_label_scre').text('-');
    $('#fsfe_label_jcre').text('-');
    $('#fsfe_label_fieldman').text('-');
    $('#fsfe_label_furnaceman').text('-');
    $('#fsfe_label_dustline').text('-');
    $('#fsfe_label_steamdry').text('-');
