    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $.each(data, function (index, value) {
                ...
                //link
                $('.' + aftable + ' tr:last').after('<tr><td class="hide_td">' + value.AF_LotId + '</td><td>' + formatDate_js(value.LotStartTime) + '</td></td><td>' + formatDate_js(value.LotEndTime) + '</td><td class="cyc_num"><a href = ' + afserverpath + '/AnodeFurnace/AFLogsheetData/' + id + '/' + sdate + '/' + edate + '/' + afid + '>' + value.AFLotNo + '</a></td><td>' + value.AF_StatusName + '</td></tr>');
        ...
        success: function (data) {
            ...
            $.each(data, function (index, value) {
                ...
                $('#aftable_cast1 tr:last').after('<tr id="' + value.AF_TimeLogId + '"><td class="border_color">'
                    ...
                    + '<td  id= "pcedit_id' + formatDate(value.AF_StartTimeVal) + '" class="select_edit_AF_act"  onclick="copy_casting_act(' + value.AF_TimeLogId + ');return false;">Copy</td>'
                    + '<td  id= "pcedit_id'
                    + formatDate(value.AF_StartTimeVal) + '" class="select_edit_AF_act"  onclick="edit_casting_act(' + value.AF_TimeLogId + ');return false;">Edit</td><td  id= "castdel_id" style="visibility:hidden;" class="select_disable_AF_act" onclick="delete_casting_act(\'' + value.ActivityDesc + '\',' + value.AF_TimeLogId + ');return false;">Delete</td></tr>'
                     );
